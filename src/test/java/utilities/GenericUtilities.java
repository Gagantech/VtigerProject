...
public class GenericUtilities {
	...
	public void deselectAllOptiions(WebElement element) {
		Select s = new Select(element);
		s.deselectAll();
	}
	...
	public void swicthToFrame(WebDriver driver, int index) {
	...
	public String catureScreenShot(WebDriver driver, String path) {
